...
zsh: command not found: #
--- ✅ OSRM server is running. Use 'docker ps' to verify. ------  OSRM server is running. Use 'docker ps' to verify. ------  OSRM server is running. Use 'docker ps' to verify. ------  OSRM server is running. Use 'docker ps' to verify. ------  OSRM server is running. Use 'docker ps' to verify. ---